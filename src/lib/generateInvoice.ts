...
export function generateInvoice(order: UserOrder) {
    ...
    doc.setFont("helvetica", "normal");
    const paymentText = order.payment_method === "cod" ? "Cash on Delivery" : (order.payment_method || "Online").replace(/\b\w/g, (c) => c.toUpperCase());
    ...
    doc.text("Thank you for shopping with FreshMart!", pageWidth / 2, thankY, { align: "center" });
