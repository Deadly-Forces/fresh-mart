export const SERVICEABLE_PINCODES = [
    ...
    // Bangalore
    '560001', '560002', '560003', '560004', '560005', '560006',
 ...
 * @returns boolean
 */
export function checkServiceability(pincode: string | undefined | null): boolean {
    ...
    return SERVICEABLE_PINCODES.includes(cleanPincode) || /^[1456]\d{5}$/.test(cleanPincode);
}
