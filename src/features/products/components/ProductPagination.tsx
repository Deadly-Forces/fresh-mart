      ...
      {pages.map((page, index) => {
        if (page === "...") {
          return (
            <div
              key={`ellipsis-${index}`}
              className="w-10 h-10 flex items-end justify-center pb-2 text-muted-foreground"
            >
        ...
        return (
          <Link
            ...
            className={`w-10 h-10 rounded-button flex items-center justify-center text-sm font-medium transition-colors ${
              isCurrentPage
