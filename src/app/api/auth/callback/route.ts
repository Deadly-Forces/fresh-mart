        ...
        try {
            ...
            if (error) {
                ...
                if (!isRetryable) {
                    ...
                    console.error(`Auth exchange error on attempt ${attempt} (non-retryable):`, error.message)
                    return { error }
                }

                // Network / TLS error — retry
                console.warn(`Auth exchange attempt ${attempt}/${maxRetries} failed (retryable):`, error.message)
            ...
            console.error(`Auth callback attempt ${attempt}/${maxRetries} failed:`, message)
