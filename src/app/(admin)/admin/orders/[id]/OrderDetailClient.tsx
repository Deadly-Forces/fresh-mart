  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-card border border-border rounded-card p-4 flex flex-wrap items-center gap-3">
        ...
        {statusMsg && (
          <span
            className={`text-sm ${statusMsg.includes("error") || statusMsg.includes("Error") ? "text-destructive" : "text-success"}`}
          >
            {statusMsg}
          </span>
        )}
          ...
          <div className="bg-card border border-border rounded-card p-5 h-full">
            ...
            <div className="space-y-3 text-sm">
              ...
              <div className="flex justify-between items-center">
                ...
                <span
                  className={`text-xs px-2 py-0.5 rounded-full font-bold uppercase tracking-wider border ${
