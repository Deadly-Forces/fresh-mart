    ...
    return (
        <div className="space-y-6">
            <div className="flex items-center justify-between">
                <Link href="/admin/products" className="flex items-center gap-2 text-sm text-muted-foreground hover:text-primary transition-colors">
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                        ...
                        <div className="space-y-2">
                            ...
                            <Input value={product.category_name || "Uncategorized"} disabled className="bg-secondary/50" />
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-5">
                        <div className="space-y-2">
                            ...
                            <Input id="price" type="number" step="0.01" min={0} value={price} onChange={(e) => setPrice(Number(e.target.value))} required />
                        </div>
                        <div className="space-y-2">
                            <Label htmlFor="comparePrice">Compare Price ($)</Label>
                            <Input id="comparePrice" type="number" step="0.01" min={0} value={comparePrice} onChange={(e) => setComparePrice(Number(e.target.value))} />
                        </div>
                        <div className="space-y-2">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        />
                        <Label htmlFor="active" className="cursor-pointer">Product is active</Label>
                    </div>
