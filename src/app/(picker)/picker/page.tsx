...
const activeOrder = {
  ...
  dueIn: "25 min",
  items: [
    { name: "Fresho Banana Robusta 6 pcs", aisle: "2", qty: 1, picked: true },
    { name: "Harvest Gold Brown Bread 400g", aisle: "2", qty: 2, picked: true },
    { name: "Amul Butter Pasteurised 500g", aisle: "5", qty: 1, picked: true },
    { name: "Amul Gold Full Cream Milk 1L", aisle: "5", qty: 3, picked: true },
    { name: "India Gate Basmati Rice 5kg", aisle: "8", qty: 1, picked: true },
    { name: "Tata Sampann Toor Dal 1kg", aisle: "8", qty: 1, picked: true },
    { name: "Epigamia Greek Yogurt Strawberry 90g", aisle: "5", qty: 2, picked: false },
    { name: "Amul Fresh Paneer 200g", aisle: "5", qty: 1, picked: false },
    { name: "Fresho Onion (Pyaaz) 1kg", aisle: "2", qty: 1, picked: false },
    { name: "Fresho Tomato (Tamatar) 500g", aisle: "2", qty: 1, picked: false },
  ],
};
