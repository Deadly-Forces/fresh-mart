    ...
    <div className="overflow-x-hidden">
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            <div className="flex flex-col items-center lg:items-start text-center lg:text-left space-y-7 max-w-xl mx-auto lg:mx-0 animate-fade-in-up">
              ...
              <p className="text-base md:text-lg text-muted-foreground leading-relaxed max-w-[440px]">
                Farm-fresh produce hand-picked and delivered to your doorstep.
                Quality you can taste, convenience you can count on.
              </p>
              ...
              <div className="flex flex-col sm:flex-row items-center gap-3 pt-2 w-full sm:w-auto">
                <Link href="/category/all" className="w-full sm:w-auto">
                  <Button
                    size="lg"
                    className="w-full sm:w-auto h-12 px-7 rounded-xl font-semibold text-sm shadow-glow group"
                  >
                    Start Shopping
                ...
                <Link href="/shop" className="w-full sm:w-auto">
                  <Button
                    variant="outline"
                    size="lg"
                    className="w-full sm:w-auto h-12 px-7 rounded-xl font-semibold text-sm border-border/80 hover:border-primary/30 hover:bg-primary/5"
                  >
                    Browse Deals
                  </Button>
                </Link>
          ...
          <div className="relative z-10 flex flex-col md:flex-row items-center gap-8">
            <div className="flex-1 text-center md:text-left">
              ...
              <p className="text-white/80 text-base mb-1 max-w-md">
                Use code{" "}
                <span className="font-bold bg-white/15 px-2 py-0.5 rounded-lg text-white">
                  FRESH20
                </span>{" "}
                at checkout and start saving on fresh groceries.
              </p>
            </div>
            <Link href="/shop" className="shrink-0">
              <Button
                size="lg"
                className="bg-white text-primary hover:bg-white/95 h-12 px-8 text-sm font-bold rounded-xl shadow-lg group"
              >
                Claim Offer
                <ArrowRight className="ml-2 w-4 h-4 group-hover:translate-x-1 transition-transform" />
              </Button>
      ...
      <section className="py-20 md:py-28 section-gradient">
        <div className="container mx-auto px-4 max-w-7xl text-center relative z-10">
          ...
          <p className="text-muted-foreground text-base max-w-md mx-auto mb-14">
            We&apos;re your partner in healthy, sustainable living.
          </p>
            ...
            {[
              {
                icon: Leaf,
                title: "Farm to Table",
                desc: "Sourced directly from local farms within 50 miles. Maximum freshness, minimum carbon footprint.",
                color: "from-emerald-500/10 to-green-500/5",
              },
              {
                icon: Truck,
                title: "Lightning Fast",
                desc: "Order in seconds, delivered in minutes. Smart logistics ensure your groceries arrive fresh.",
                color: "from-blue-500/10 to-cyan-500/5",
              },
              {
                icon: ShieldCheck,
                title: "Best Prices",
                desc: "No middlemen means better prices. Plus exclusive deals and rewards for loyal customers.",
                color: "from-amber-500/10 to-orange-500/5",
              },
            ].map((item, i) => (
              <div key={i} className="card-aesthetic p-8 text-center group">
                <div
                  className={`w-14 h-14 rounded-2xl bg-gradient-to-br ${item.color} flex items-center justify-center text-primary mx-auto mb-5 group-hover:scale-110 transition-transform duration-300`}
                >
