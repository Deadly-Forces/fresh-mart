      ...
      <div className="container mx-auto px-4 max-w-4xl py-12">
        <div className="rounded-2xl border border-border/50 bg-background/70 backdrop-blur-sm p-8 md:p-12 shadow-soft">
          <div className="prose prose-slate max-w-none text-muted-foreground prose-headings:text-foreground prose-headings:font-bold prose-a:text-primary prose-a:no-underline hover:prose-a:underline">
            ...
            <ul>
              <li>
                Assisting you in navigation and making your visit more
                personalized.
              </li>
              <li>
              ...
              <li>
                Analyzing your use of our products, services, or applications to
            ...
            <p>
              ...
              information about how you use a website, like which pages you
              visited and which links you clicked on. None of this information
              ...
              personal features.
              <br />
              <strong>Targeting Cookies:</strong> These are cookies used to
            ...
            <p>
              We may update this policy from time to time to reflect, for
              example, changes to the cookies we use or for other operational,
              legal or regulatory reasons. Please revisit this policy regularly
