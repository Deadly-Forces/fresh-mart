...
export default function CareersPage() {
    const jobs = [
        { title: "Store Manager", location: "Downtown Branch", type: "Full-Time", gradient: "from-emerald-500 to-green-400" },
        { title: "Delivery Driver", location: "Multiple Locations", type: "Full-Time / Part-Time", gradient: "from-blue-500 to-cyan-400" },
        { title: "Produce Specialist", location: "Uptown Branch", type: "Full-Time", gradient: "from-amber-500 to-orange-400" },
        { title: "Customer Support Representative", location: "Remote", type: "Full-Time", gradient: "from-purple-500 to-pink-400" }
    ];
        ...
        <div className="overflow-hidden">
            ...
            <div className="relative section-gradient py-20 lg:py-28">
                ...
                <div className="container mx-auto px-4 max-w-7xl relative text-center">
                    ...
                    <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight mb-6">
                        Join Our <span className="bg-gradient-to-r from-primary to-emerald-400 bg-clip-text text-transparent">Team</span>
                    </h1>
                    <p className="text-muted-foreground text-lg lg:text-xl max-w-2xl mx-auto">
                        We&apos;re always looking for passionate individuals who love fresh food and great customer service. Build your career with FreshMart.
                    </p>
                </div>
            </div>
            ...
            <div className="container mx-auto px-4 max-w-5xl py-16 lg:py-20">
                <div className="grid gap-4">
                    {jobs.map((job, i) => (
                        <div key={i} className="group bg-card border border-border/50 rounded-2xl p-6 flex flex-col sm:flex-row sm:items-center justify-between gap-4 hover:border-primary/20 hover:shadow-card-hover hover:-translate-y-0.5 transition-all duration-300 cursor-pointer">
                            <div className="flex items-start sm:items-center gap-4">
                                <div className={`w-12 h-12 bg-gradient-to-br ${job.gradient} rounded-xl flex items-center justify-center text-white flex-shrink-0 shadow-sm group-hover:scale-110 transition-transform duration-300`}>
                ...
                <div className="mt-16 relative rounded-3xl overflow-hidden">
                    ...
                    <div className="relative p-8 md:p-12 text-center">
                        ...
                        <h2 className="font-bold text-2xl lg:text-3xl mb-3">Don&apos;t see a perfect fit?</h2>
