...
export const metadata = {
  ...
  description:
    "Learn about the security measures we implement to protect your data and ensure safe transactions at Fresh Mart.",
};
...
const securityMeasures = [
  {
    ...
    description:
      "All data transmitted between your browser and our servers is encrypted using TLS 1.3 / HTTPS. We enforce HSTS (HTTP Strict Transport Security) to prevent downgrade attacks.",
  ...
  },
  {
    ...
    description:
      "We sanitize all user-generated HTML content using DOMPurify before rendering, preventing cross-site scripting attacks. Our Content Security Policy headers provide an additional layer of defense.",
  ...
  },
  {
    ...
    description:
      "All inputs are validated server-side using Zod schemas. We never trust client-provided data — prices, totals, and quantities are verified against our database before processing orders.",
  ...
  },
  {
    ...
    description:
      "We use Supabase Auth with row-level security (RLS) policies on every database table. Admin actions require both authentication and role verification at the application level.",
  ...
  },
  {
    ...
    description:
      "Our application sets comprehensive HTTP security headers including Content-Security-Policy, X-Frame-Options, X-Content-Type-Options, Referrer-Policy, and Permissions-Policy.",
  ...
  },
  {
    ...
    title: "Rate Limiting",
    description:
      "Sensitive operations like placing orders are rate-limited to prevent abuse. This protects against automated attacks and ensures fair access for all customers.",
      ...
      <section className="relative section-gradient overflow-hidden py-14 md:py-20">
        ...
        <div className="container mx-auto px-4 max-w-4xl relative z-10 text-center">
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto">
            Your safety is our priority. Here&apos;s how we protect your data,
            your transactions, and your privacy.
          </p>
        </div>
      </section>
        ...
        <section className="rounded-2xl border border-border/50 bg-background/70 backdrop-blur-sm p-8 md:p-12 shadow-soft">
          ...
          <div className="prose prose-slate max-w-none text-muted-foreground prose-headings:text-foreground">
            <p>
              ...
              security issue in our application, we encourage you to report it
              responsibly.
            </p>
            <p>
              ...
              with a detailed description of the vulnerability. We will
              acknowledge receipt within 48 hours and work to address the issue
              promptly.
            </p>
            <p className="text-sm">
