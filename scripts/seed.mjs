...
async function seed() {
    ...
    const data = fs.readFileSync(path.resolve(process.cwd(), "src/features/products/utils/products.json"), "utf8");
    ...
    const productsToInsert = products.map((p) => {
        ...
        let imageUrl = "https://images.unsplash.com/photo-1542838132-92c53300491e?w=800&q=80";
        if (p.categorySlug === "fruits") imageUrl = "https://images.unsplash.com/photo-1610832958506-aa56368176cf?w=800&q=80";
        if (p.categorySlug === "vegetables") imageUrl = "https://images.unsplash.com/photo-1598170845058-32b9d6a5da37?w=800&q=80";
        if (p.categorySlug === "dairy-eggs") imageUrl = "https://images.unsplash.com/photo-1550583724-b2692b85b150?w=800&q=80";
        if (p.categorySlug === "meat-seafood") imageUrl = "https://images.unsplash.com/photo-1607623814075-e51df1bdc82f?w=800&q=80";
        if (p.categorySlug === "bakery") imageUrl = "https://images.unsplash.com/photo-1509440159596-0249088772ff?w=800&q=80";
